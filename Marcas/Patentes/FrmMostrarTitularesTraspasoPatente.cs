...
{
    public partial class FrmMostrarTitularesTraspasoPatente : Form
    {
        ...
        public FrmMostrarTitularesTraspasoPatente()
        {
            InitializeComponent();
            this.Load += FrmMostrarTitularesTraspasoPatente_Load; // Mueve la lógica de carga aquí
        }
        ...
        private async void FrmMostrarTitularesTraspasoPatente_Load(object sender, EventArgs e)
        {
        ...
        private void iconButton3_Click(object sender, EventArgs e)
        {
            ...
            if (dtgTitulares.SelectedRows.Count > 0) // Verifica si hay filas seleccionadas
            {
                ...
                if (filaSeleccionada.DataBoundItem is DataRowView dataRowView)
                {
                    ...
                    {
                        AgregarTraspasoPatente.nombreTitularN = detallesTitular[0].nombre;
                        this.Close();
                    }
                    else
                    {
