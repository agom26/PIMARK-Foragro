...
{
    public partial class FrmMostrarRegistradasPatente : Form
    {
        ...
        public FrmMostrarRegistradasPatente()
        {
            InitializeComponent();
            this.Load += FrmMostrarRegistradasPatente_Load;
    ...
    ref byte[] logo, bool registroChek, string registro, string folio, string libro)
        ...
        private async void FrmMostrarRegistradasPatente_Load(object sender, EventArgs e)
        {
