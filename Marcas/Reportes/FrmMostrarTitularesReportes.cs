...
{
    public partial class FrmMostrarTitularesReportes : Form
    {
        PersonaModel personaModel = new PersonaModel();
        public FrmMostrarTitularesReportes()
        {
            InitializeComponent();
            this.Load += FrmMostrarTitularesReportes_Load; // Mueve la lógica de carga aquí
        }
        ...
        private async void FrmMostrarTitularesReportes_Load(object sender, EventArgs e)
        {
