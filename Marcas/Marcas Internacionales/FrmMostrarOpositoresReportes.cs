...
{
    public partial class FrmMostrarOpositoresReportes : Form
    {
        ...
        public FrmMostrarOpositoresReportes()
        {
            InitializeComponent();
            this.Load += FrmMostrarOpositoresReportes_Load; // Mueve la lógica de carga aquí
        }
        ...
        private async void FrmMostrarOpositoresReportes_Load(object sender, EventArgs e)
        {
